...
test.describe('Authentication', () => {
  test('should show public landing page before login', async ({ page }) => {
    await page.goto('/');
    await expect(page.getByRole('heading', { name: /Sistem Informasi Manajemen Rumah Sakit Esa Unggul/ })).toBeVisible();
  ...
  test('should show login page and allow login', async ({ page }) => {
    await page.goto('/login');
    await expect(page.getByRole('heading', { name: 'Masuk ke Rekam Medis Elektronik' })).toBeVisible();
